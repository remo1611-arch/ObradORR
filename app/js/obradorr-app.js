...
function printWorkspaceView() {
    ...
    <section class="workspace">
      <div class="card">
        <div class="panel-title"><div><h2>Sesión actual</h2><p>Busca elaboraciones, ajusta cantidades y genera fichas o pedido de producción.</p></div></div>
      ...
      <div class="card">
        ...
        <h3 style="margin-top:16px">Modelo de ficha de salida</h3>
