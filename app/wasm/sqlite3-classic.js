var sqlite3ClassicScriptUrl = (globalThis.document && globalThis.document.currentScript && globalThis.document.currentScript.src) || (globalThis.location && globalThis.location.href) || "";
...
globalThis.sqlite3Worker1Promiser.defaultConfig = {
    worker: function () {
        return new Worker(new URL("sqlite3-worker1.mjs", sqlite3ClassicScriptUrl), { type: "module" });
    },
...
globalThis.sqlite3Worker1Promiser.v2 = function callee(config = callee.defaultConfig) {
    ...
    else if ("function" === typeof (config === null || config === void 0 ? void 0 : config.onready)) {
...
async function sqlite3InitModule(moduleArg = {}) {
    ...
    ((_b = (_a = globalThis.process) === null || _a === void 0 ? void 0 : _a.versions) === null || _b === void 0 ? void 0 : _b.node) && ((_c = globalThis.process) === null || _c === void 0 ? void 0 : _c.type);
    var thisProgram = "./this.program";
    var _scriptName = sqlite3ClassicScriptUrl;
    var scriptDirectory = "";
    ...
    */
    function abort(what) {
        ...
        readyPromiseReject === null || readyPromiseReject === void 0 ? void 0 : readyPromiseReject(e);
        throw e;
    }
    var wasmBinaryFile;
    function findWasmBinary() {
        ...
        return new URL("sqlite3.wasm", sqlite3ClassicScriptUrl).href;
    }
    ...
    */
    ...
    var FS_stdin_getChar = () => {
        ...
        if (!FS_stdin_getChar_buffer.length) {
            var result = null;
            if ((_a = globalThis.window) === null || _a === void 0 ? void 0 : _a.prompt) {
    ...
    var TTY = {
        ...
        default_tty_ops: {
            ...
            fsync(tty) {
                var _a;
                if (((_a = tty.output) === null || _a === void 0 ? void 0 : _a.length) > 0) {
                    out(UTF8ArrayToString(tty.output));
                    tty.output = [];
                }
            },
    ...
    var FS = {
        ...
        chrdev_stream_ops: {
            open(stream) {
                ...
                (_b = (_a = stream.stream_ops).open) === null || _b === void 0 ? void 0 : _b.call(_a, stream);
            },
            llseek() {
        ...
        createDevice(parent, name, input, output) {
            ...
            (_a = (_b = FS.createDevice).major) !== null && _a !== void 0 ? _a : (_b.major = 64);
            ...
            FS.registerDevice(dev, {
                ...
                close(stream) {
                    var _a;
                    if ((_a = output === null || output === void 0 ? void 0 : output.buffer) === null || _a === void 0 ? void 0 : _a.length)
                        output(10);
                },
                read(stream, buffer, offset, length, pos) {
                    var bytesRead = 0;
    ...
    */
    ...
    var SYSCALLS = {
        calculateAt(dirfd, path, allowEmpty) {
            ...
            if (dirfd === -100)
                ...
                dir = SYSCALLS.getStreamFromFD(dirfd).path;
            if (path.length == 0) {
                if (!allowEmpty)
                    throw new FS.ErrnoError(44);
                return dir;
    ...
    var _emscripten_resize_heap = (requestedSize) => {
        ...
        for (var cutDown = 1; cutDown <= 4; cutDown *= 2) {
            ...
            if (growMemory(Math.min(maxHeapSize, alignMemory(Math.max(requestedSize, overGrownHeapSize), 65536))))
                return true;
        }
        return false;
    };
    ...
    var getEnvStrings = () => {
        ...
        if (!getEnvStrings.strings) {
            var env = {
                ...
                "PWD": "/",
                "HOME": "/home/web_user",
                "LANG": ((_b = (_a = globalThis.navigator) === null || _a === void 0 ? void 0 : _a.language) !== null && _b !== void 0 ? _b : "C").replace("-", "_") + ".UTF-8",
                "_": getExecutableName()
            };
            for (var x in ENV)
                if (ENV[x] === void 0)
    ...
    function _fd_sync(fd) {
        ...
        try {
            var stream = SYSCALLS.getStreamFromFD(fd);
            return (_b = (_a = stream.stream_ops) === null || _a === void 0 ? void 0 : _a.fsync) === null || _b === void 0 ? void 0 : _b.call(_a, stream);
        }
        catch (e) {
            if (typeof FS == "undefined" || !(e.name === "ErrnoError"))
                throw e;
    ...
    function run() {
        ...
        function doRun() {
            ...
            if (ABORT)
                return;
            initRuntime();
            readyPromiseResolve === null || readyPromiseResolve === void 0 ? void 0 : readyPromiseResolve(Module);
    ...
    Module.runSQLite3PostLoadInit = async function (sqlite3InitScriptInfo, EmscriptenModule, sqlite3IsUnderTest) {
        ...
        globalThis.sqlite3ApiBootstrap = async function sqlite3ApiBootstrap(apiConfig = globalThis.sqlite3ApiConfig || sqlite3ApiBootstrap.defaultConfig) {
            ...
            */
            ...
            if (sqlite3.__isUnderTest) {
                ...
                const iw = (_a = sqlite3.scriptInfo) === null || _a === void 0 ? void 0 : _a.instantiateWasm;
                if (iw) {
        ...
        */
        ...
        globalThis.WhWasmUtilInstaller = function WhWasmUtilInstaller(target) {
            ...
            */
            ...
            const __ptrIR = (_a = target.pointerIR) !== null && _a !== void 0 ? _a : (target.pointerIR = "i32");
            const __ptrSize = (_b = target.pointerSize) !== null && _b !== void 0 ? _b : (target.pointerSize = "i32" === __ptrIR ? 4 : "i64" === __ptrIR ? 8 : 0);
            ...
            */
            ...
            if (!target.exports)
                Object.defineProperty(target, "exports", {
                    enumerable: true,
                    configurable: true,
                    get: () => { var _a; return (_a = target.instance) === null || _a === void 0 ? void 0 : _a.exports; }
                });
            ...
            */
            const typedArrayPart = (aTypedArray, begin, end) => {
                if (8 === __ptrSize) {
                    if ("bigint" === typeof begin)
                        begin = Number(begin);
                    if ("bigint" === typeof end)
                        end = Number(end);
                }
        ...
        */
                ...
                if (config.wasmUtilTarget) {
                    ...
                    if (!tgt.instance.exports.memory)
                        /**
                                           ...
                                           imported into WASM).
                                           */
                        tgt.memory = ((_b = (_a = config === null || config === void 0 ? void 0 : config.imports) === null || _a === void 0 ? void 0 : _a.env) === null || _b === void 0 ? void 0 : _b.memory) || toss("Missing 'memory' object!");
        ...
        globalThis.Jaccwabyt = function StructBinderFactory(config) {
            ...
            config.realloc;
            const log = config.log || console.debug.bind(console), memberPrefix = config.memberPrefix || "", memberSuffix = config.memberSuffix || "", BigInt = globalThis["BigInt"], BigInt64Array = globalThis["BigInt64Array"], bigIntEnabled = (_a = config.bigIntEnabled) !== null && _a !== void 0 ? _a : !!BigInt64Array;
            let ptr;
            ...
            * descriptor. */
            ...
            value v. */
            const rop = (v) => {
                return Object.assign(Object.assign({}, rop0()), { value: v });
            };
            ...
            const __allocStruct = function f(ctor, obj, xm) {
                ...
                if (arguments.length >= 3)
                    if (xm && "object" === typeof xm) {
                        opt = xm;
                        xm = opt === null || opt === void 0 ? void 0 : opt.wrap;
                    }
                    else {
                        checkPtr(xm);
                        opt = { wrap: xm };
                ...
                if (xm) {
                    checkPtr(xm);
                    ownsPointer = !!(opt === null || opt === void 0 ? void 0 : opt.takeOwnership);
                }
                else {
                    const nX = (_a = opt === null || opt === void 0 ? void 0 : opt.extraBytes) !== null && _a !== void 0 ? _a : 0;
                    if (nX < 0 || nX !== (nX | 0))
                        toss("Invalid extraBytes value:", opt === null || opt === void 0 ? void 0 : opt.extraBytes);
                    nAlloc = ctor.structInfo.sizeof + nX;
                    xm = alloc(nAlloc) || toss("Allocation of", ctor.structName, "structure failed.");
                    ownsPointer = true;
                }
                try {
                    if (opt === null || opt === void 0 ? void 0 : opt.debugFlags)
                    ...
                    ii.zod = !!(opt === null || opt === void 0 ? void 0 : opt.zeroOnDispose);
                    if ((opt === null || opt === void 0 ? void 0 : opt.ondispose) && opt.ondispose !== xm)
            ...
            const looksLikeASig = function f(sig) {
                var _a, _b;
                (_a = f.rxSig1) !== null && _a !== void 0 ? _a : (f.rxSig1 = /^[ipPsjfdcC]$/);
                (_b = f.rxSig2) !== null && _b !== void 0 ? _b : (f.rxSig2 = /^[vipPsjfdcC]\([ipPsjfdcC]*\)$/);
            ...
            */
            StructType.prototype = Object.create(null, {
                ...
                extraBytes: {
                    ...
                    get: function () {
                        var _a, _b;
                        return (_b = (_a = getInstanceHandle(this, false)) === null || _a === void 0 ? void 0 : _a.xb) !== null && _b !== void 0 ? _b : 0;
                    }
                },
                zeroOnDispose: {
                    configurable: false,
                    ...
                    get: function () {
                        var _a, _b;
                        return (_b = (_a = getInstanceHandle(this, false)) === null || _a === void 0 ? void 0 : _a.zod) !== null && _b !== void 0 ? _b : !!this.structInfo.zeroOnDispose;
                    }
                },
                pointer: {
                    configurable: false,
                    ...
                    get: function () {
                        var _a;
                        return (_a = getInstanceHandle(this, false)) === null || _a === void 0 ? void 0 : _a.p;
                    },
            ...
            */
            Object.defineProperties(StructType, {
                ...
                hasExternalPointer: rop((v) => {
                    ...
                    return !!((ii === null || ii === void 0 ? void 0 : ii.p) && !(ii === null || ii === void 0 ? void 0 : ii.ownsPointer));
                }),
                memberKey: __memberKeyProp
            });
            /**
            ...
            */
            const makeMemberStructWrapper = function callee(ctor, name, si) {
                ...
                */
                const __innerStructs = (_a = callee.innerStructs) !== null && _a !== void 0 ? _a : (callee.innerStructs = new Map());
                ...
                (_b = si.structName) !== null && _b !== void 0 ? _b : (si.structName = ctor.structName + "::" + name);
                si.key = key;
                si.name = name;
            ...
            const makeMemberWrapper = function f(ctor, name, si) {
                ...
                if (si.readOnly)
                    ...
                    prop.set = function (v) {
                        ...
                        */
                        if (dbg.setter)
                            log("debug.setter:", f.cache.setters[sigGlyph], "for", sigIR(sigGlyph), xPropName, "@", this.pointer, "+", si.offset, "sz", si.sizeof, v);
                        if (!this.pointer)
                            toss("Cannot set native property on a disposed", this.structName, "instance.");
                        if (setterProxy)
                            v = setterProxy.apply(this, [key, v]);
                        if (null === v || void 0 === v)
                            v = __NullPtr;
            ...
            const StructBinderImpl = function StructBinderImpl(structName, si, opt = Object.create(null)) {
                ...
                */
                ...
                if (1 === arguments.length) {
                    ...
                    si = ads(si);
                    (_a = si.name) !== null && _a !== void 0 ? _a : (si.name = structName);
                }
                else
                    si = ads(si);
                structName !== null && structName !== void 0 ? structName : (structName = si.structName);
                structName !== null && structName !== void 0 ? structName : (structName = opt.structName);
                if (!structName)
                ...
                if (!autoCalc) {
                    ...
                    (_b = si.offset) !== null && _b !== void 0 ? _b : (si.offset = 0);
                }
                else
                    (_c = si.offset) !== null && _c !== void 0 ? _c : (si.offset = 0);
            ...
            */
            ...
            delete globalThis.Jaccwabyt;
            {
                ...
                */
                ...
                wasm.xWrap.argAdapter("sqlite3_filename", __xArgPtr)("sqlite3_context*", __xArgPtr)("sqlite3_value*", __xArgPtr)("void*", __xArgPtr)("sqlite3_changegroup*", __xArgPtr)("sqlite3_changeset_iter*", __xArgPtr)("sqlite3_session*", __xArgPtr)("sqlite3_stmt*", (v) => { var _a; return __xArgPtr(v instanceof (((_a = sqlite3 === null || sqlite3 === void 0 ? void 0 : sqlite3.oo1) === null || _a === void 0 ? void 0 : _a.Stmt) || nilType) ? v.pointer : v); })("sqlite3*", (v) => { var _a; return __xArgPtr(v instanceof (((_a = sqlite3 === null || sqlite3 === void 0 ? void 0 : sqlite3.oo1) === null || _a === void 0 ? void 0 : _a.DB) || nilType) ? v.pointer : v); })("sqlite3_vfs*", (v) => {
                    if ("string" === typeof v)
                ...
                if (wasm.exports.sqlite3_declare_vtab)
                    wasm.xWrap.argAdapter("sqlite3_index_info*", (v) => __xArgPtr(v instanceof (capi.sqlite3_index_info || nilType) ? v.pointer : v))("sqlite3_module*", (v) => __xArgPtr(v instanceof (capi.sqlite3_module || nilType) ? v.pointer : v));
                /**
            ...
            const StructPtrMapper = function (name, StructType) {
                ...
                */
                return Object.assign(Object.create(null), {
                    ...
                    dispose: (pCObj) => { var _a, _b; return (_b = (_a = __xWrap(pCObj, true)) === null || _a === void 0 ? void 0 : _a.dispose) === null || _b === void 0 ? void 0 : _b.call(_a); }
                });
            };
            /**
        ...
        */
        globalThis.sqlite3ApiBootstrap.initializers.push(function (sqlite3) {
            var _a, _b, _c;
            var _KVVfsStorage_instances, _KVVfsStorage_map, _KVVfsStorage_keys, _KVVfsStorage_size, _KVVfsStorage_getKeys;
            if ((_b = (_a = sqlite3.config.disable) === null || _a === void 0 ? void 0 : _a.vfs) === null || _b === void 0 ? void 0 : _b.kvvfs)
                return;
            ...
            */
            cache.memBuffer = (id = 0) => { var _a; var _b; return (_a = (_b = cache.buffer.pool)[id]) !== null && _a !== void 0 ? _a : (_b[id] = wasm.alloc(cache.buffer.n)); };
            ...
            const noop = () => { };
            const debug = sqlite3.__isUnderTest ? (...args) => { var _a, _b; return (_b = (_a = sqlite3.config).debug) === null || _b === void 0 ? void 0 : _b.call(_a, "kvvfs:", ...args); } : noop;
            const warn = (...args) => { var _a, _b; return (_b = (_a = sqlite3.config).warn) === null || _b === void 0 ? void 0 : _b.call(_a, "kvvfs:", ...args); };
            const error = (...args) => { var _a, _b; return (_b = (_a = sqlite3.config).error) === null || _b === void 0 ? void 0 : _b.call(_a, "kvvfs:", ...args); };
            /**
            ...
            */
            class KVVfsStorage {
                constructor() {
                    _KVVfsStorage_instances.add(this);
                    _KVVfsStorage_map.set(this, Object.create(null));
                    _KVVfsStorage_keys.set(this, null);
                    _KVVfsStorage_size.set(this, 0);
                    this.clear();
                }
                key(n) {
                    if (n < 0 || n >= __classPrivateFieldGet(this, _KVVfsStorage_size, "f"))
                        return null;
                    return __classPrivateFieldGet(this, _KVVfsStorage_instances, "m", _KVVfsStorage_getKeys).call(this)[n];
                }
                getItem(k) {
                    var _a;
                    return (_a = __classPrivateFieldGet(this, _KVVfsStorage_map, "f")[k]) !== null && _a !== void 0 ? _a : null;
                }
                setItem(k, v) {
                    var _a;
                    if (!(k in __classPrivateFieldGet(this, _KVVfsStorage_map, "f"))) {
                        __classPrivateFieldSet(this, _KVVfsStorage_size, (_a = __classPrivateFieldGet(this, _KVVfsStorage_size, "f"), ++_a), "f");
                        __classPrivateFieldSet(this, _KVVfsStorage_keys, null, "f");
                    }
                    __classPrivateFieldGet(this, _KVVfsStorage_map, "f")[k] = "" + v;
                }
                removeItem(k) {
                    var _a;
                    if (k in __classPrivateFieldGet(this, _KVVfsStorage_map, "f")) {
                        delete __classPrivateFieldGet(this, _KVVfsStorage_map, "f")[k];
                        __classPrivateFieldSet(this, _KVVfsStorage_size, (_a = __classPrivateFieldGet(this, _KVVfsStorage_size, "f"), --_a), "f");
                        __classPrivateFieldSet(this, _KVVfsStorage_keys, null, "f");
                    }
                }
                clear() {
                    __classPrivateFieldSet(this, _KVVfsStorage_map, Object.create(null), "f");
                    __classPrivateFieldSet(this, _KVVfsStorage_keys, null, "f");
                    __classPrivateFieldSet(this, _KVVfsStorage_size, 0, "f");
                }
                get length() {
                    return __classPrivateFieldGet(this, _KVVfsStorage_size, "f");
                }
            }
            _KVVfsStorage_map = new WeakMap(), _KVVfsStorage_keys = new WeakMap(), _KVVfsStorage_size = new WeakMap(), _KVVfsStorage_instances = new WeakSet(), _KVVfsStorage_getKeys = function _KVVfsStorage_getKeys() {
                var _a;
                return __classPrivateFieldSet(this, _KVVfsStorage_keys, (_a = __classPrivateFieldGet(this, _KVVfsStorage_keys, "f")) !== null && _a !== void 0 ? _a : Object.keys(__classPrivateFieldGet(this, _KVVfsStorage_map, "f")), "f");
            };
            ...
            */
            const deleteStorage = function (store) {
                ...
                ((_a = kvvfs === null || kvvfs === void 0 ? void 0 : kvvfs.log) === null || _a === void 0 ? void 0 : _a.xClose) && debug("cleaning up storage handles [", store.jzClass, other, "]", store);
                    ...
                    for (const ear of store.listeners) {
                        ...
                        if (f) {
                            ...
                            if ("write" === eventName && ear.decodePages && +args[0] > 0) {
                                ev.data = [args[0]];
                                if (wcache === null || wcache === void 0 ? void 0 : wcache[args[0]]) {
                                    ev.data[1] = wcache[args[0]];
                                    continue;
                                }
                                u8enc !== null && u8enc !== void 0 ? u8enc : (u8enc = new TextEncoder("utf-8"));
                                z0 !== null && z0 !== void 0 ? z0 : (z0 = cache.memBuffer(10));
                                z1 !== null && z1 !== void 0 ? z1 : (z1 = cache.memBuffer(11));
                                ...
                                if (rc > 0) {
                                    wcache !== null && wcache !== void 0 ? wcache : (wcache = Object.create(null));
                            ...
                            try {
                                (_b = (_a = f(ev)) === null || _a === void 0 ? void 0 : _a.catch) === null || _b === void 0 ? void 0 : _b.call(_a, catchForNotify);
                            }
                            catch (e) {
                ...
                recordHandler: {
                    xRcrdRead: (zClass, zKey, zBuf, nBuf) => {
                        ...
                        try {
                            ...
                            ((_a = kvvfs === null || kvvfs === void 0 ? void 0 : kvvfs.log) === null || _a === void 0 ? void 0 : _a.xRcrdRead) && warn("xRcrdRead", jzClass, jXKey, nBuf, store);
                    ...
                    xRcrdWrite: (zClass, zKey, zData) => {
                        ...
                        try {
                            ...
                            ((_a = kvvfs === null || kvvfs === void 0 ? void 0 : kvvfs.log) === null || _a === void 0 ? void 0 : _a.xRcrdWrite) && warn("xRcrdWrite", jxKey, store);
                    ...
                    xRcrdDelete: (zClass, zKey) => {
                        ...
                        try {
                            const store = storageForZClass(zClass);
                            const jxKey = jsKeyForStorage(store, zClass, zKey);
                            ((_a = kvvfs === null || kvvfs === void 0 ? void 0 : kvvfs.log) === null || _a === void 0 ? void 0 : _a.xRcrdDelete) && warn("xRcrdDelete", jxKey, store);
                ...
                vfs: {
                    xOpen: function (pProtoVfs, zName, pProtoFile, flags, pOutFlags) {
                        ...
                        try {
                            ...
                            ((_a = kvvfs === null || kvvfs === void 0 ? void 0 : kvvfs.log) === null || _a === void 0 ? void 0 : _a.xOpen) && debug("xOpen", jzClass, "flags =", flags);
                            ...
                            if (s) {
                                ...
                                ((_b = kvvfs === null || kvvfs === void 0 ? void 0 : kvvfs.log) === null || _b === void 0 ? void 0 : _b.xOpen) && debug("xOpen installed storage handle [", nm, nm + "-journal", "]", s);
                            }
                    ...
                    xAccess: function (pProtoVfs, zPath, flags, pResOut) {
                        ...
                        try {
                            ...
                            const jzPath = (s === null || s === void 0 ? void 0 : s.jzClass) || wasm.cstrToJs(zPath);
                            if ((_a = kvvfs === null || kvvfs === void 0 ? void 0 : kvvfs.log) === null || _a === void 0 ? void 0 : _a.xAccess)
                ...
                ioDb: {
                    xClose: function (pFile) {
                        ...
                        try {
                            ...
                            ((_a = kvvfs === null || kvvfs === void 0 ? void 0 : kvvfs.log) === null || _a === void 0 ? void 0 : _a.xClose) && debug("xClose", pFile, h);
                            if (h) {
                    ...
                    xFileControl: function (pFile, opId, pArg) {
                        ...
                        try {
                            ...
                            ((_a = kvvfs === null || kvvfs === void 0 ? void 0 : kvvfs.log) === null || _a === void 0 ? void 0 : _a.xFileControl) && debug("xFileControl", h, "op =", opId);
                            if (opId === capi.SQLITE_FCNTL_PRAGMA && kvvfsInternal.disablePageSizeChange) {
                                ...
                                if ("page_size" === wasm.cstrToJs(zName)) {
                                    ((_b = kvvfs === null || kvvfs === void 0 ? void 0 : kvvfs.log) === null || _b === void 0 ? void 0 : _b.xFileControl) && debug("xFileControl pragma", wasm.cstrToJs(zName));
                                    const zVal = wasm.peekPtr(wasm.ptr.add(pArg, 2 * wasm.ptr.size));
                                    if (zVal) {
                                        ((_c = kvvfs === null || kvvfs === void 0 ? void 0 : kvvfs.log) === null || _c === void 0 ? void 0 : _c.xFileControl) && warn("xFileControl pragma", h, "NOT setting page size to", wasm.cstrToJs(zVal));
                                        h.file.$szPage = -1;
                                        return 0;
                                    }
                                    else if (h.file.$szPage > 0) {
                                        ((_d = kvvfs === null || kvvfs === void 0 ? void 0 : kvvfs.log) === null || _d === void 0 ? void 0 : _d.xFileControl) && warn("xFileControl", h, "getting page size", h.file.$szPage);
                    ...
                    xSync: function (pFile, flags) {
                        ...
                        try {
                            const h = pFileHandles.get(pFile);
                            ((_a = kvvfs === null || kvvfs === void 0 ? void 0 : kvvfs.log) === null || _a === void 0 ? void 0 : _a.xSync) && debug("xSync", h);
                            util.assert(h, "Missing KVVfsFile handle");
            ...
            */
            const sqlite3_js_kvvfs_export = function callee(...args) {
                ...
                if (!store)
                    toss3(capi.SQLITE_NOTFOUND, "There is no kvvfs storage named", opt === null || opt === void 0 ? void 0 : opt.name);
                const s = store.storage;
                ...
                for (; i < n; ++i) {
                    ...
                    if (!keyPrefix || k.startsWith(keyPrefix)) {
                        let kk = (_b = (_a = (keyPrefix ? rxTail.exec(k) : void 0)) === null || _a === void 0 ? void 0 : _a[1]) !== null && _b !== void 0 ? _b : k;
                        switch (kk) {
                            case "jrnl":
                            ...
                            default:
                                ...
                                if (opt.decodePages) {
                                    ...
                                    let i = 0;
                                    for (; i < n; ++i)
                                        heap[wasm.ptr.add(z, i)] = spg.codePointAt(i) & 255;
            ...
            */
            const sqlite3_js_kvvfs_import = function (exp, overwrite = false) {
                if (!(exp === null || exp === void 0 ? void 0 : exp.timestamp) || !exp.name || void 0 === exp.size || !Array.isArray(exp.pages))
                ...
                try {
                    ...
                    if (exp.pages[0] instanceof Uint8Array)
                        exp.pages.forEach((u, ndx) => {
                            const n = u.length;
                            zEnc !== null && zEnc !== void 0 ? zEnc : (zEnc = cache.memBuffer(1));
            ...
            */
            const sqlite3_js_kvvfs_listen = function (opt) {
                ...
                if (opt.events)
                    ((_a = store.listeners) !== null && _a !== void 0 ? _a : (store.listeners = [])).push(opt);
            };
            /**
            ...
            */
            const sqlite3_js_kvvfs_unlisten = function (opt) {
                const store = storageForZClass(opt === null || opt === void 0 ? void 0 : opt.storage);
                if ((store === null || store === void 0 ? void 0 : store.listeners) && opt.events) {
            ...
            if ((_c = sqlite3.oo1) === null || _c === void 0 ? void 0 : _c.DB) {
                /**
            ...
            if (sqlite3.__isUnderTest && sqlite3.vtab) {
                ...
                */
                ...
                const theModule = function f() {
                    var _a;
                    return (_a = f.mod) !== null && _a !== void 0 ? _a : (f.mod = new sqlite3.capi.sqlite3_module().setupModule({
        ...
        globalThis.sqlite3ApiBootstrap.initializers.push(function (sqlite3) {
            "use strict";
            var _a, _b;
            if (((_b = (_a = sqlite3.config.disable) === null || _a === void 0 ? void 0 : _a.vfs) === null || _b === void 0 ? void 0 : _b.opfs) && sqlite3.config.disable.vfs["opfs-vfs"])
                return;
            ...
            */
            opfsUtil.thisThreadHasOPFS = () => {
                var _a;
                return globalThis.FileSystemHandle && globalThis.FileSystemDirectoryHandle && globalThis.FileSystemFileHandle && globalThis.FileSystemFileHandle.prototype.createSyncAccessHandle && ((_a = navigator === null || navigator === void 0 ? void 0 : navigator.storage) === null || _a === void 0 ? void 0 : _a.getDirectory);
            };
            /**
            ...
            */
            opfsUtil.getRootDir = async function f() {
                var _a;
                return (_a = f.promise) !== null && _a !== void 0 ? _a : (f.promise = navigator.storage.getDirectory().then((d) => {
            ...
            */
            opfsUtil.rmfr = async function () {
                ...
                try {
                    for (var _d = true, _e = __asyncValues(dir.values()), _f; _f = await _e.next(), _a = _f.done, !_a; _d = true) {
                        _c = _f.value;
                        _d = false;
                        const handle = _c;
            ...
            */
            opfsUtil.vfsInstallationFeatureCheck = function (vfsName) {
                ...
                if (!globalThis.SharedArrayBuffer || !globalThis.Atomics)
                    toss("Cannot install OPFS: Missing SharedArrayBuffer and/or Atomics.", "The server must emit the COOP/COEP response headers to enable those.", "See https://sqlite.org/wasm/doc/trunk/persistence.md#coop-coep");
                else if ("undefined" === typeof WorkerGlobalScope)
                    toss("The OPFS sqlite3_vfs cannot run in the main thread", "because it requires Atomics.wait().");
                else if (!globalThis.FileSystemHandle || !globalThis.FileSystemDirectoryHandle || !((_b = (_a = globalThis.FileSystemFileHandle) === null || _a === void 0 ? void 0 : _a.prototype) === null || _b === void 0 ? void 0 : _b.createSyncAccessHandle) || !((_c = navigator === null || navigator === void 0 ? void 0 : navigator.storage) === null || _c === void 0 ? void 0 : _c.getDirectory))
            ...
            */
            opfsUtil.initOptions = function callee(vfsName, options) {
                ...
                (_a = options.verbose) !== null && _a !== void 0 ? _a : (options.verbose = urlParams.has("opfs-verbose") ? +urlParams.get("opfs-verbose") : 1);
                (_b = options.sanityChecks) !== null && _b !== void 0 ? _b : (options.sanityChecks = urlParams.has("opfs-sanity-check"));
                if (!opfsUtil.proxyUri) {
                    opfsUtil.proxyUri = "sqlite3-opfs-async-proxy.js";
                    if ((_c = sqlite3.scriptInfo) === null || _c === void 0 ? void 0 : _c.sqlite3Dir)
                        opfsUtil.proxyUri = sqlite3.scriptInfo.sqlite3Dir + opfsUtil.proxyUri;
                }
                (_d = options.proxyUri) !== null && _d !== void 0 ? _d : (options.proxyUri = opfsUtil.proxyUri);
            ...
            */
            opfsUtil.createVfsState = function () {
                ...
                opfsVfs.addOnDispose("$zName", opfsVfs.$zName, opfsIoMethods
                /**
                ...
                */
                ...
                opfsVfs.metrics = util.nu({
                    ...
                    dump: function () {
                        ...
                        (_b = (_a = opfsVfs.worker) === null || _a === void 0 ? void 0 : _a.postMessage) === null || _b === void 0 ? void 0 : _b.call(_a, { type: "opfs-async-metrics" });
                    },
                    reset: function () {
                        let k;
                ...
                */
                ...
                for (const k of [
                    ...
                    state.sq3Codes[k] = (_a = capi[k]) !== null && _a !== void 0 ? _a : toss("Maintenance required: not found:", k);
                ...
                opfsVfs.vfsSyncWrappers = {
                    ...
                    xOpen: function f(pVfs, zName, pFile, flags, pOutFlags) {
                        ...
                        if (rc) {
                            ...
                            if (zToFree)
                                fh.sq3File.addOnDispose(zToFree);
                ...
                */
                opfsVfs.bindVfs = function (ioMethods, callback) {
                    ...
                    return new Promise(function (promiseResolve_, promiseReject_) {
                        ...
                        const opfsAsyncProxyUrl = new URL("sqlite3-opfs-async-proxy.js", sqlite3ClassicScriptUrl);
                        ...
                        let zombieTimer = setTimeout(() => {
                            if (void 0 === promiseWasRejected)
                                promiseReject(/* @__PURE__ */ new Error("Timeout while waiting for OPFS async proxy worker."));
                        }, 4e3);
        ...
        globalThis.sqlite3ApiBootstrap.initializers.push(function (sqlite3) {
            var _a, _b;
            if (!sqlite3.opfs || ((_b = (_a = sqlite3.config.disable) === null || _a === void 0 ? void 0 : _a.vfs) === null || _b === void 0 ? void 0 : _b.opfs))
                return;
        ...
        globalThis.sqlite3ApiBootstrap.initializers.push(function (sqlite3) {
            ...
            if ((_b = (_a = sqlite3.config.disable) === null || _a === void 0 ? void 0 : _a.vfs) === null || _b === void 0 ? void 0 : _b["opfs-sahpool"])
                return;
            const toss = sqlite3.util.toss;
            ...
            */
            class OpfsSAHPool {
                constructor(options = Object.create(null)) {
                    ...
                    _OpfsSAHPool_mapSAHToName.set(this, /* @__PURE__ */ new Map());
                    _OpfsSAHPool_mapFilenameToSAH.set(this, /* @__PURE__ */ new Map());
                    _OpfsSAHPool_availableSAH.set(this, /* @__PURE__ */ new Set());
                    _OpfsSAHPool_mapS3FileToOFile_.set(this, /* @__PURE__ */ new Map());
                ...
                getFileNames() {
                    const rc = [];
                    for (const n of __classPrivateFieldGet(this, _OpfsSAHPool_mapFilenameToSAH, "f").keys())
                        rc.push(n);
                    return rc;
                }
                /**
                ...
                */
                async addCapacity(n) {
                    for (let i = 0; i < n; ++i) {
                        ...
                        const ah = await (await __classPrivateFieldGet(this, _OpfsSAHPool_dhOpaque, "f").getFileHandle(name, { create: true })).createSyncAccessHandle();
                ...
                */
                async reduceCapacity(n) {
                    ...
                    for (const ah of Array.from(__classPrivateFieldGet(this, _OpfsSAHPool_availableSAH, "f"))) {
                        ...
                        ah.close();
                        await __classPrivateFieldGet(this, _OpfsSAHPool_dhOpaque, "f").removeEntry(name);
                ...
                */
                async acquireAccessHandles(clearFiles = false) {
                    ...
                    const files = [];
                    try {
                        for (var _d = true, _e = __asyncValues(__classPrivateFieldGet(this, _OpfsSAHPool_dhOpaque, "f")), _f; _f = await _e.next(), _a = _f.done, !_a; _d = true) {
                            _c = _f.value;
                            _d = false;
                            const [name, h] = _c;
                            if ("file" === h.kind)
                ...
                */
                getAssociatedPath(sah) {
                    ...
                    if (__classPrivateFieldGet(this, _OpfsSAHPool_apBody, "f")[0] && (flags & capi.SQLITE_OPEN_DELETEONCLOSE || (flags & PERSISTENT_FILE_TYPES) === 0)) {
                    ...
                    const compDigest = this.computeDigest(__classPrivateFieldGet(this, _OpfsSAHPool_apBody, "f"), flags);
                    if (fileDigest.every((v, i) => v === compDigest[i])) {
                        const pathBytes = __classPrivateFieldGet(this, _OpfsSAHPool_apBody, "f").findIndex((v) => 0 === v);
                        if (0 === pathBytes)
                            sah.truncate(HEADER_OFFSET_DATA);
                        return pathBytes ? textDecoder.decode(__classPrivateFieldGet(this, _OpfsSAHPool_apBody, "f").subarray(0, pathBytes)) : "";
                    }
                    else {
                ...
                */
                setAssociatedPath(sah, path, flags) {
                    ...
                    const digest = this.computeDigest(__classPrivateFieldGet(this, _OpfsSAHPool_apBody, "f"), flags);
                ...
                */
                async reset(clearFiles) {
                    ...
                    __classPrivateFieldSet(this, _OpfsSAHPool_dhOpaque, await __classPrivateFieldGet(this, _OpfsSAHPool_dhVfsRoot, "f").getDirectoryHandle(OPAQUE_DIR_NAME, { create: true }), "f");
                    this.releaseAccessHandles();
                ...
                */
                async removeVfs() {
                    ...
                    try {
                        this.releaseAccessHandles();
                        await __classPrivateFieldGet(this, _OpfsSAHPool_dhVfsRoot, "f").removeEntry(OPAQUE_DIR_NAME, { recursive: true });
                        __classPrivateFieldSet(this, _OpfsSAHPool_dhOpaque, void 0, "f");
                        await __classPrivateFieldGet(this, _OpfsSAHPool_dhVfsParent, "f").removeEntry(__classPrivateFieldGet(this, _OpfsSAHPool_dhVfsRoot, "f").name, { recursive: true });
                        __classPrivateFieldSet(this, _OpfsSAHPool_dhVfsRoot, __classPrivateFieldSet(this, _OpfsSAHPool_dhVfsParent, void 0, "f"), "f");
                    }
                    catch (e) {
                ...
                */
                pauseVfs() {
                    if (__classPrivateFieldGet(this, _OpfsSAHPool_mapS3FileToOFile_, "f").size > 0)
                        sqlite3.SQLite3Error.toss(capi.SQLITE_MISUSE, "Cannot pause VFS", this.vfsName, "because it has opened files.");
                    if (__classPrivateFieldGet(this, _OpfsSAHPool_mapSAHToName, "f").size > 0) {
                ...
                */
                isPaused() {
                    return 0 === __classPrivateFieldGet(this, _OpfsSAHPool_mapSAHToName, "f").size;
                }
                /**
                ...
                */
                async unpauseVfs() {
                    if (0 === __classPrivateFieldGet(this, _OpfsSAHPool_mapSAHToName, "f").size)
                        return this.acquireAccessHandles(false).then(() => capi.sqlite3_vfs_register(__classPrivateFieldGet(this, _OpfsSAHPool_cVfs, "f"), 0), this);
                    return this;
                }
                ...
                async importDbChunked(name, callback) {
                    const sah = __classPrivateFieldGet(this, _OpfsSAHPool_mapFilenameToSAH, "f").get(name) || this.nextAvailableSAH() || toss("No available handles to import to.");
                    sah.truncate(0);
            ...
            */
            class OpfsSAHPoolUtil {
                ...
                pauseVfs() {
                    __classPrivateFieldGet(this, _OpfsSAHPoolUtil_p, "f").pauseVfs();
                    return this;
                }
                async unpauseVfs() {
                    return __classPrivateFieldGet(this, _OpfsSAHPoolUtil_p, "f").unpauseVfs().then(() => this);
                }
                isPaused() {
                    return __classPrivateFieldGet(this, _OpfsSAHPoolUtil_p, "f").isPaused();
                }
            }
            ...
            */
            sqlite3.installOpfsSAHPoolVfs = async function (options = Object.create(null)) {
                ...
                if (!globalThis.FileSystemHandle || !globalThis.FileSystemDirectoryHandle || !globalThis.FileSystemFileHandle || !globalThis.FileSystemFileHandle.prototype.createSyncAccessHandle || !((_a = navigator === null || navigator === void 0 ? void 0 : navigator.storage) === null || _a === void 0 ? void 0 : _a.getDirectory))
                    return initPromises[vfsName] = Promise.reject(/* @__PURE__ */ new Error("Missing required OPFS APIs."));
                /**
        ...
        globalThis.sqlite3ApiBootstrap.initializers.push(function (sqlite3) {
            var _a, _b;
            if (!sqlite3.opfs || ((_b = (_a = sqlite3.config.disable) === null || _a === void 0 ? void 0 : _a.vfs) === null || _b === void 0 ? void 0 : _b["opfs-wl"]))
                return;
            const util = sqlite3.util;
            sqlite3.util.toss;
...
sqlite3InitModule = (function () {
    ...
    */
    const sIMS = globalThis.sqlite3InitModuleState = Object.assign(Object.create(null), {
        ...
        urlParams: ((_b = globalThis === null || globalThis === void 0 ? void 0 : globalThis.location) === null || _b === void 0 ? void 0 : _b.href) ? new URL(globalThis.location.href).searchParams : new URLSearchParams(),
    ...
    const sIM = globalThis.sqlite3InitModule = function ff(...args) {
        var _a, _b;
        sIMS.emscriptenLocateFile = (_a = args[0]) === null || _a === void 0 ? void 0 : _a.locateFile;
        sIMS.emscriptenInstantiateWasm = (_b = args[0]) === null || _b === void 0 ? void 0 : _b.instantiateWasm;
...
//#endregion
globalThis.sqlite3InitModule = sqlite3_bundler_friendly_default;
globalThis.sqlite3Worker1Promiser = sqlite3_worker1_promiser_default;
