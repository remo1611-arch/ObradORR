# WINDOWS_GUIDE · ObradORR 1.0.0-rc.8

## Proba local en PowerShell

```powershell
$ZipName = "ObradORR_1_0_0_RC8.zip"
$ZipPath = Join-Path $env:USERPROFILE "Downloads\$ZipName"
$TestDir = Join-Path $env:USERPROFILE "Desktop\ObradORR_RC8_TEST"
...
Set-Location "$TestDir\ObradORR_1_0_0_RC8"
