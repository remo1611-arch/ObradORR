# MIGRATIONS · ObradORR 1.0.0-rc.2

La versión incluye tabla `schema_migrations` y metadatos `app_meta` actualizados a `1.0.0-rc.2`.

## Política

- Las copias de trabajo deben pertenecer a ObradORR.
- Deben coincidir `release_tag` y `cache_tag` con `obradorr-100-rc2`.
