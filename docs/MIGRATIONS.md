# MIGRATIONS · ObradORR 1.0.0-rc.1

La versión incluye tabla `schema_migrations` y metadatos `app_meta` actualizados a `1.0.0-rc.1`.

## Política

- Las copias de trabajo deben pertenecer a ObradORR.
- Deben coincidir `release_tag` y `cache_tag` con `obradorr-100-rc1`.
