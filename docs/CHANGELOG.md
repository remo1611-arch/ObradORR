...
- Edición guiada ampliada.
- Prefermento editable.
- Pasos técnicos editables.
- Componentes elaborados editables.
- Componentes semilla para Babka, Croissant y Torta de nata.
- Control de ciclos en subrecetas y componentes panaderos.
